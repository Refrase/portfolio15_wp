...
jQuery(document).ready(function($) {
    ...
    var showLabel = function() {
        $(this).children("span").stop(true).fadeIn(600);
    };
    ...
    function chooseBG() {
        $(".intro-bg").css({
            "background-image": "url('" + BGs[randomNumBG] + "')"
        });
    }
    chooseBG();
    /* ----- / ----- */
    ...
    var randDuration = Math.floor(Math.random() * 1e3 + 1);
    var effectAttr = {
        effect: "bounce",
        direction: "down",
    ...
    function setVideoSizeToParent() {
        $(".piece__video").css({
            ...
            height: $(".piece__pic").innerWidth() * .56 + "px"
        });
    }
    ...
    function setAirlookSizeToParent() {
        $(".piece__video--airlook").css({
            ...
            height: $(".piece__pic-visuali--airlook").innerWidth() * .56 + "px"
        });
    }
    ...
    function setIframeSizeToParent() {
        ...
        if (iframeWrap > 768) {
            // Sæt til desktop landscape
            $(".piece__iframe").css({
                width: iframeWrap + "px",
                height: iframeWrap * .56 + "px"
            });
        } else {
            // Sæt til portrait iPad/iPhone forhold
            $(".piece__iframe").css({
                width: iframeWrap + "px",
