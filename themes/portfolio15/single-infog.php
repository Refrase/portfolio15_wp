<?php get_header(); ?>
  ...
  <?php include 'piecemeta-top.php'; ?>
    ...
    <ul class="piece__pic piece__pic-infog--small">
      <li><p class="piece__splitter">Mobile</p></li>
      <li><img src="images/pieces/infog/facebookalgorithm_mob.png"></li>
    </ul>
    <ul class="piece__pic piece__pic-infog--big">
      <li><p class="piece__splitter">Desktop</p></li>
		  <li><img src="images/pieces/infog/facebookalgorithm.png"></li>
    </ul>
